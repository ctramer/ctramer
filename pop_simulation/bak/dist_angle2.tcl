...
for {set frame 0} {$frame < 1000} {incr frame} {
	...
	$sel_c70 delete
	foreach j $resDBP {
            set sel2 [atomselect top "resid $j and name C58" frame $frame]
		...
		if { [$sel4 num] > 0 } {
			set sel3 [atomselect top "resid $j and name C61" frame $frame"]
			...
			$sel6 delete
			set vec7 [veccross [vecsub $vec2 $vec3] [vecsub $vec5 $vec6] ]
			...
			set sel_end1 [atomselect top "resid $j and name H4" frame $frame]
			set sel_end2 [atomselect top "resid $j and name H22" frame $frame]
			...
			$selp1 delete
                        $selp2 delete
			set angp1 [expr {acos([vecdot [vecnorm [vecsub $vec2 $vec3]] [vecnorm [vecsub $vecp1 $vecp2]]])*180/acos(-1)}]
			...
			$selp1 delete
                        $selp2 delete
                        set angp2 [expr {acos([vecdot [vecnorm [vecsub $vec2 $vec3]] [vecnorm [vecsub $vecp1 $vecp2]]])*180/acos(-1)}]
			...
			$selp1 delete
                        $selp2 delete
                        set angp3 [expr {acos([vecdot [vecnorm [vecsub $vec2 $vec3]] [vecnorm [vecsub $vecp1 $vecp2]]])*180/acos(-1)}]
			...
			$selp1 delete
                        $selp2 delete
                        set angp4 [expr {acos([vecdot [vecnorm [vecsub $vec2 $vec3]] [vecnorm [vecsub $vecp1 $vecp2]]])*180/acos(-1)}]
